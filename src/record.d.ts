export type ObservedRecordKind='GENESIS'|'BUNDLE'|'WALLET'|'TOKEN'|'TRANSFER'|'TOKEN_TRANSFER'|'SWAP'|'ADD_LIQUIDITY'|'REMOVE_LIQUIDITY'|'TOKEN_CREATION'|'CONTRACT_DEPLOYMENT'|'CONTRACT_EXECUTION'|'CONTRACT_CODE'|'RUNTIME_AUTHORIZATION'|'RECORD'|'TRANSACTION'|'UNKNOWN';
